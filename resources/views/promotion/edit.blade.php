...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            @endif
            <form action="{{ route('update', $promotion->id) }}" method="post">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="start-date" name="start-date" value="{{ gmdate('Y-m-d\TH:i',strtotime($promotion->date_start)) }}">
                </div>
                <div class="form-group">
                    <label for="end_date">End date</label>
                    <input type="datetime-local" class="form-control" id="end-date" name="end-date" value="{{ gmdate('Y-m-d\TH:i',strtotime($promotion->date_end)) }}">
                </div>
