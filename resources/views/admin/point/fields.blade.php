...
<div class="form-group col-sm-6">
    ...
    {!! Form::input('number', 'vote', 5 , ['class' => 'form-control', 'step' => '1', 'min' => '0', 'max' => '10']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::input('number', 'share', 5 , ['class' => 'form-control', 'step' => '1', 'min' => '0', 'max' => '10']) !!}
</div>
<div class="clearfix"></div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::input('number', 'book', 5 , ['class' => 'form-control', 'step' => '1', 'min' => '0', 'max' => '10']) !!}
</div>
<div class="clearfix"></div>
