        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    ...
                    {!! Form::button('<i class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => 'messageDeletePoint(this)', 'value' => trans('message.are_you_sure')]) !!}
                </div>
                {!! Form::close() !!}
            </td>
        </tr>
